...
@section('content')
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header">Editar Chofer</h3>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <p><a href="{{route('detailsUserChofer', $user->id)}}" class="btn btn-primary"><i
                        ...
                        <div class="row">
                            <div class="form-group">
                                <div class="col-lg-6">
                                    {!! Form::model($user,['route' => ['admin.chofer.update', $user], 'method' => 'PUT']) !!}
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        {!! Field::text('id_user',['label' => 'Driver License','required','class'=> 'form-control', 'placeholder' => 'Please, write the number id']) !!}
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        {!! Field::text('role', 'Chofer',['label'=> 'Role','class' => 'form-control','disabled'=>'enable']) !!}
                                        {!! Field::hidden('role', 'chofer',['label'=> 'Role','class' => 'form-control']) !!}
